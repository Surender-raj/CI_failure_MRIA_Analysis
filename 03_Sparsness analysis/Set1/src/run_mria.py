...
def mria_run(DATA, op_factor, all_disimp, imp_flex, disr_dict_sup, disr_dict_dem, distance_dict, solvername):
    ...
    MRIA_RUN2.create_disaster_data(disr_dict_sup, disr_dict_dem, op_factor, all_disimp,imp_flex, distance_dict)
    ...
    MRIA_RUN3.create_disaster_data(disr_dict_sup, disr_dict_dem, op_factor, all_disimp, imp_flex, distance_dict, new_rat)
